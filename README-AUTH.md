...
By default the app will attempt to seed a default admin user with email `colasito@admin` and password `admin123` automatically on first visit to the login page. If you prefer to seed manually:
